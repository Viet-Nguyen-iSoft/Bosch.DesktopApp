namespace LTP.Truck.Forms
{
  partial class PopupFilter
  {
    ...
    private void InitializeComponent()
    {
      ...
      label21.Location = new Point(9, 83);
      ...
      cbbStatus.Font = new Font("Roboto", 20F);
      cbbStatus.FormattingEnabled = true;
      cbbStatus.Items.AddRange(new object[] { "Tất cả", "Chưa hoàn thành", "Hoàn thành", "Đã xóa" });
      cbbStatus.Location = new Point(106, 72);
      cbbStatus.Name = "cbbStatus";
      cbbStatus.Size = new Size(334, 41);
      ...
      btnConfirm.Location = new Point(118, 186);
      btnConfirm.Name = "btnConfirm";
      btnConfirm.Padding = new Padding(10, 0, 0, 0);
      btnConfirm.Size = new Size(158, 55);
      ...
      btnClose.Location = new Point(282, 186);
      btnClose.Name = "btnClose";
      btnClose.Padding = new Padding(10, 0, 0, 0);
      btnClose.Size = new Size(158, 55);
