namespace LTP.Truck.MasterData
{
  partial class PopupUser
  {
    ...
    private void InitializeComponent()
    {
      ...
      tableLayoutPanel6.Size = new Size(202, 67);
      ...
      tableLayoutPanel4.Location = new Point(0, 67);
      ...
      label3.Font = new Font("Roboto", 14.25F, FontStyle.Bold, GraphicsUnit.Point, 0);
      ...
      txtUsername.Location = new Point(206, 14);
      ...
      txtUsername.Size = new Size(574, 38);
      ...
      txtDisplayName.BackColor = SystemColors.Window;
      txtDisplayName.BorderColor = Color.Black;
      txtDisplayName.BorderFocusColor = Color.HotPink;
      txtDisplayName.BorderRadius = 5;
      ...
      txtDisplayName.Padding = new Padding(10, 7, 10, 7);
      txtDisplayName.PasswordChar = false;
      txtDisplayName.PlaceholderColor = Color.DarkGray;
      txtDisplayName.PlaceholderText = "";
      txtDisplayName.Size = new Size(574, 38);
      ...
      tableLayoutPanel2.Size = new Size(790, 60);
      ...
      btnConfirm.Location = new Point(433, 3);
      ...
      btnClose.Location = new Point(613, 3);
    ...
    private Common.Custom.RJTextBox txtPassword;
    private Common.Custom.RJTextBox txtUsername;
    private Common.Custom.RJTextBox txtDisplayName;
